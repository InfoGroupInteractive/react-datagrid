...
module.exports = React.createClass({
    ...
    fillEmptyRows: function fillEmptyRows() {
        ...
        var cols = this.props.virtualColumnRendering && this.props.endColIndex !== null ? this.props.columns.slice(this.props.startColIndex, this.props.endColIndex + 1) : this.props.columns;
        ...
        if (height > this.props.renderCount * this.props.rowHeight) {
            ...
            for (var i = 0; i < numEmptyRows; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    cellWidth = cols[j].sizeStyle.width ? { width: cols[j].sizeStyle.width, minWidth: cols[j].sizeStyle.width } : cols[j].width ? { width: cols[j].sizeStyle.width, minWidth: cols[j].sizeStyle.width } : { minWidth: cols[j].minWidth, WebkitFlex: 1, msFlex: 1, flex: 1 };
